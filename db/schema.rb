...
ActiveRecord::Schema.define(version: 20170301090717) do
  ...
  create_table "filerecords", id: :integer, default: -> { "nextval('filemeta_id_seq'::regclass)" }, force: :cascade do |t|
    ...
    t.integer "accession"
    t.string  "aid"
    t.index ["accession"], name: "index_filerecords_on_accession", unique: true, using: :btree
  ...
  create_table "pipelines", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.index ["owner_id", "slug"], name: "index_pipelines_on_owner_id_and_slug", using: :btree
